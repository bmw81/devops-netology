...
![Create new branch and switch](/img/new_branch.png)
6. Посмотрите, как визуально выглядит ваша схема коммитов: https://github.com/YOUR_ACCOUNT/devops-netology/network.
![Branches graph](/img/branches_graph.png)
...
![Branches graph - 2](/img/branches_graph-2.png)
`git log`
![Fix git log](/img/fix_git_log.png)
